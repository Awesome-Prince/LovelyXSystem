...
async def status(event):
    msg = await event.client.send_file(event.chat_id, file="https://telegra.ph/file/df37584b57dc87199f3b0.mp4", caption="Connecting to Lovely Systems", reply_to=event)
    time.sleep(1)
